...
date_df = pd.DataFrame(
   np.array(data_ar),
   columns=['start', 'end', 'block', 'C36_1', 'C36_2', 'C36_3', 'C36_4', 'C36_5', 'C36_6', 'C36_7', 'C36_8'])
...
obs_param = merge4.apply(lambda r: ct.observable(r['RA'], r['DEC'], alma1, r['ephem'], r['minAR'], r['maxAR'], r['array'], r['SB_UID']), axis=1)
merge5 = pd.merge(merge4, obs_param, on='SB_UID', how='left')
# availability = merge5.apply(lambda r: ct.avail_calc(r['rise'], r['set'], r['C36_1'], r['C36_2'], r['C36_3'], r['C36_4'], r['C36_5'], r['C36_6'], r['C36_7'], r['C36_8'], r['up'], r['band_SB'], date_df), axis=1)
...
def av_arrays_opt(sel):
    ...
    for r in sel.iterrows():
        ...
        if data.RA == 0 or data.up == 24:
            ...
            use_ra[map_ra < data.set] += (data.estimatedTime_SB / data.up) / data.twelve_good
            use_ra[map_ra > data.rise] += (data.estimatedTime_SB / data.up) / data.twelve_good
        else:
            use_ra[(map_ra > data.rise) & (map_ra < data.set)] += (data.estimatedTime_SB / data.up) / data.twelve_good
...
def av_arrays(sel):
    ...
    for r in sel.iterrows():
        ...
        if data.RA == 0 or data.up == 24:
            use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10 = add_band('all', data.estimatedTime_SB / 24., data.band_SB, use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10)
            continue
        ...
        if data.up > 4:
            if 2 < (data.RA / 15.) < 22:
                ...
                set = (data.RA / 15.) + 2.
                up = 4
                use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10 = add_band((map_ra > rise) & (map_ra < set), data.estimatedTime_SB / up, data.band_SB, use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10)
            else:
                if (data.RA / 15.) < 2:
                    rise = 22 + (data.RA / 15.)
                    set = (data.RA / 15.) + 2
                    ...
                    set = 2 - (24 - (data.RA / 15.))
                    up = 4
                use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10 = add_band(map_ra < set, data.estimatedTime_SB / up, data.band_SB, use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10)
                use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10 = add_band(map_ra > rise, data.estimatedTime_SB / up, data.band_SB, use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10)
            continue
        ...
        if data.rise > data.set:
            ...
            set = data.set
            up = data.up
            if up > 4 and data.ephem is False:
                if rise < data.RA / 15. - 2.:
                    rise = data.RA / 15. - 2.
                if set > data.RA / 15. + 2.:
                    set = data.RA / 15. + 2.
                up = 4.
    ...
    return map_ra, [use_ra_b3, use_ra_b4, use_ra_b6, use_ra_b7, use_ra_b8, use_ra_b9, use_ra_b10]
...
c361bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-1"')
c362bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-2"')
c363bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-3"')
c364bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-4"')
c365bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-5"')
c366bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-6"')
c367bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-7"')
c368bf = summary.query('APRCGrade in ["A", "B", "C"] and twelve_good > 0 and array == "TWELVE-M" and BestConf == "C36-8"')
